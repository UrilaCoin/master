...
// Copyright (c) 2016-2017 The Urila developers
...
#define SPORK_5_MAX_VALUE_DEFAULT 1000                            //1000 URA
...
#define SPORK_16_MN_WINNER_MINIMUM_AGE_DEFAULT 100               // Age in seconds. This should be > MASTERNODE_REMOVAL_SECONDS to avoid
