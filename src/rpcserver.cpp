...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Urila features */
        {"urila", "masternode", &masternode, true, true, false},
        {"urila", "listmasternodes", &listmasternodes, true, true, false},
        {"urila", "getmasternodecount", &getmasternodecount, true, true, false},
        {"urila", "masternodeconnect", &masternodeconnect, true, true, false},
        {"urila", "masternodecurrent", &masternodecurrent, true, true, false},
        {"urila", "masternodedebug", &masternodedebug, true, true, false},
        {"urila", "startmasternode", &startmasternode, true, true, false},
        {"urila", "createmasternodekey", &createmasternodekey, true, true, false},
        {"urila", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"urila", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"urila", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"urila", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"urila", "getmasternodescores", &getmasternodescores, true, true, false},
        {"urila", "mnbudget", &mnbudget, true, true, false},
        {"urila", "preparebudget", &preparebudget, true, true, false},
        {"urila", "submitbudget", &submitbudget, true, true, false},
        {"urila", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"urila", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"urila", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"urila", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"urila", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"urila", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"urila", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"urila", "checkbudgets", &checkbudgets, true, true, false},
        {"urila", "mnsync", &mnsync, true, true, false},
        {"urila", "spork", &spork, true, true, false},
        {"urila", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"urila", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use urilad, or the -server option to urila-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> urila-cli " + methodname + " " + args + "\n";
}
