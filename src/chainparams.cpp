...
public:
    CMainParams()
    {
         ...
         *   vMerkleTree: e0028e
         */
        const char* pszTimestamp = "Urila StartBlock";
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1531396517;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 655433;

        hashGenesisBlock = genesis.GetHash();
        //  MineGenesis(genesis);
        assert(hashGenesisBlock == uint256("00000893de07d374f5bb809c0201ce958b723dfd9610296152b415462641de4c"));
        assert(genesis.hashMerkleRoot == uint256("fc5a0809238e1a4e3f0691b39996617c393933506b1703f52703696c5b8fb59b"));
       

        vSeeds.push_back(CDNSSeedData("185.227.110.214", "185.227.110.214"));         // Single node address 1
        vSeeds.push_back(CDNSSeedData("185.181.8.207", "185.181.8.207"));           // Single node address 2
        ...
        strSporkKey = "03a283b3193c7b9daa585859a41e2fb49864d514d6bb01be330f569a5d92c30876";
        strObfuscationPoolDummyAddress = "UNNzXJE63Q4hpP3qNZkAA3o1QrWfcmqwU9";
...
*/
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet urila addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet urila script addresses start with '8' or '9'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet urila BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet urila BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet urila BIP44 coin type is '1' (All coin's testnet default)
...
public:
    CRegTestParams()
    {
        ...
        nToCheckBlockUpgradeMajority = 1000;
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // Urila: 1 day
        nTargetSpacing = 1 * 60;        // Urila: 1 minutes
