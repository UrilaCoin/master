                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Urila Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Urila address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and urila: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Urila Core"), this);
    aboutAction->setStatusTip(tr("Show information about Urila Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Urila"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Urila addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Urila addresses"));
    ...
    openAction->setStatusTip(tr("Open a Urila: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Urila Core help message to get a list with possible Urila command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Urila Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Urila network", "", count));
}
...
{
    QString strTitle = tr("Urila Core"); // default title
