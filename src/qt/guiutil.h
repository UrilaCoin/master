...
/** Utility functions used by the Urila Qt UI.
 */
namespace GUIUtil
{
...
// Render Urila addresses in monospace font
...
// Parse "urila:" URI into recipient object, return true on successful parsing
