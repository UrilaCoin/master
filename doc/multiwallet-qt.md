...
In order to support loading of multiple wallets in urila-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is urila.cpp.
...
Changes to urila.cpp
----------------------
urila.cpp is the entry point into urila-qt, and as such, will require some minor modifications to provide hooks for
